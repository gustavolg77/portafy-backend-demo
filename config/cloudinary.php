...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Windows local environments commonly miss a configured CA bundle for PHP
    | cURL. Keep verification enabled outside local unless explicitly changed.
    |
    */
    'verify_ssl' => env('CLOUDINARY_VERIFY_SSL', env('APP_ENV') !== 'local'),
];
